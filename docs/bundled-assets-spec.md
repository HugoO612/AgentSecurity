...
- `bridge/assets/agent-security-agent.pkg`
...
- SHA256 for `agent-security-agent.pkg`
- build source
- packaging timestamp
- update policy
...
- place the real agent package at `bridge/assets/agent-security-agent.pkg`
...
- `AGENT_SECURITY_AGENT_INSTALL_SHA256=<64-character SHA256 for bridge/assets/agent-security-agent.pkg>`
