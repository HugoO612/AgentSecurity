  ...
  return {
    ...
    args: [
      ...
      [
        ...
        `Remove-Item -Force -ErrorAction SilentlyContinue '${escapePowershellString(`${context.runtimeDir}\\agent.state`)}','${escapePowershellString(`${context.runtimeDir}\\agent.pid`)}','${escapePowershellString(`${context.runtimeDir}\\onboarding.url`)}','${escapePowershellString(`${context.runtimeDir}\\runtime.env`)}','${escapePowershellString(context.stagedInstallerPath)}','${escapePowershellString(context.stagedRootfsPath)}'`,
